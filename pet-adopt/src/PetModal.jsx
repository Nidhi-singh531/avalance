...
export default function PetModal({ pet, onClose }) {
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <span style={{ marginRight: '0.5rem' }}>
                  {enhancedPet.traits.shotsUpToDate ? '✅' : '⚠'}
                </span>
              ...
              <div style={{ 
                ...
                <span style={{ marginRight: '0.5rem' }}>
                  {enhancedPet.traits.goodWithCats ? '✅' : '⚠'}
                </span>
              ...
              <div style={{ 
                ...
                <span style={{ marginRight: '0.5rem' }}>
                  {enhancedPet.traits.goodWithDogs ? '✅' : '⚠'}
                </span>
              ...
              <div style={{ 
                ...
                <span style={{ marginRight: '0.5rem' }}>
                  {enhancedPet.traits.goodWithKids ? '✅' : '⚠'}
                </span>
  ...
  <PetModal
    pet={selectedPet}
    onAdopt={(id) => { adoptPet(id); setSelectedPet(null); }}
